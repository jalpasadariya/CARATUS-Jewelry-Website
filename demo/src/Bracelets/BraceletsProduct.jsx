                        ...
                        <div className="dropdown">
                            ...
                            <div className="dropdown-content">
                                ...
                                <div className="price-inputs">
                                    ...
                                    <span>to</span>
                                    <span>$</span>
                                    <span className="price">5165.00</span>
                                </div>
                            </div>
                                )}
                        </div>
                ...
                <div className="product-main-inner">
                    <div className="product-item">
                        <div className="product-item-inner">
                         ...
                         <img src="./Images/4_1_22.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/5_1_da.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/6_1_18.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                     ...
                     <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/7_1_3a.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                            <Link className="image-box">
                         <img src="./Images/9_1_5.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/9_1_5f.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/10_1_ea.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                     ...
                     <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/11_1_11.webp" alt="front" className="front-img" />
                         <img src="./Images/11G.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
...
export default BraceletsProduct;