                        ...
                        <div className="dropdown">
                            ...
                            <div className="dropdown-content">
                                ...
                                <div className="price-inputs">
                                    ...
                                    <span>to</span>
                                    <span>$</span>
                                    <span className="price">1774.00</span>
                                </div>
                            </div>
                                )}
                        </div>
...
<div className="sort-container">
    ...
    <span className="product-count">62 Products</span>
</div>
</div>
                    </div>
                ...
                <div className="product-main-inner">
                    <div className="product-item">
                        <div className="product-item-inner">
                         ...
                         <img src="./Images/1_1_5.webp" alt="front" className="front-img" />
                         <img src="./Images/model_2.webp" alt="back" className="back-img" />
                          </Link>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                            <Link className="image-box">
                         <img src="./Images/1_1_534.webp" alt="front" className="front-img" />
                         <img src="./Images/model_2.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/1_1_9.webp" alt="front" className="front-img" />
                         <img src="./Images/model_2.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                    ...
                    <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/1_1_53.webp" alt="front" className="front-img" />
                         <img src="./Images/model_2.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
                     ...
                     <div className="product-item">
                        <div className="product-item-inner">
                             <Link className="image-box">
                         <img src="./Images/1_1_5e.webp" alt="front" className="front-img" />
                         <img src="./Images/model_2.webp" alt="back" className="back-img" />
                          </Link>
                          <div className="wishlist-container">
                                                      <span className="wishlist">♡</span>
